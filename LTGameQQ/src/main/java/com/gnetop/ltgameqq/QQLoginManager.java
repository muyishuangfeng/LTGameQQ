...
public class QQLoginManager {
     ...
     * @param baseUrl   联网的URL
     * @param LTAppID   乐推APPID
     * @param LTAppKey  乐推appKey
     * @param mListener 接口回调
     */
    public static void qqLogin(Context context, String APP_ID, String baseUrl, String LTAppID,
        ...
        if (!isValid) {
            startLogin(context, mTencent, baseUrl, LTAppID, LTAppKey, mListener);
        } else {
    ...
    private static void startLogin(final Context context, final Tencent mTencent,
                                   final String baseUrl, final String LTAppID,
                ...
                if (jsonResponse.length() == 0) {
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(token) && !TextUtils.isEmpty(expires)
                            ...
                            //登录
                            LoginBackManager.qqLogin(context, baseUrl, LTAppID, LTAppKey,map
                                    , mListener);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
